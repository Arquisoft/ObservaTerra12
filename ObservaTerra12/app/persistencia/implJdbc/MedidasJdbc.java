...
public class MedidasJdbc 
{
	 ...
	 * @param measure - Medida a registrar.
	...
	/**
	 * Función auxiliar que recupera el próximo identificador único 
	 * a asignar al item a guardar.
	 ...
	 * @param identificador - Identificador de la medida
	 * @return - Medida encontrada
	 * @throws SQLException
	 */
	public Measure buscarMedidaPorIdentificador(Long identificador) throws SQLException
	{
